...
const RiskPredictions: React.FC<RiskPredictionsProps> = ({ predictions }) => {
  ...
  const totalPotentialLoss = sortedPredictions.reduce(
    (sum, prediction) =>
      sum + prediction.potentialLoss * prediction.probability,
    0
  );
                  ...
                  <div className="flex items-center mr-3">
                    ...
                    <span>
                      Medium:{" "}
                      {
                        sortedPredictions.filter(
                          (p) =>
                            p.probability * p.impact > 3 &&
                            p.probability * p.impact <= 6
                        ).length
                      }
                    </span>
                  </div>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h4 className="text-2xl font-bold mt-1 text-red-600">
              ...
              <CardContent className="p-4">
                ...
                <div className="mt-3 pt-3 border-t flex items-center text-xs text-gray-500">
                  <div className="text-gray-500">
                    Based on historical data analysis and AI predictions
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h4 className="text-2xl font-bold mt-1">
                      {sortedPredictions.reduce(
                        (sum, p) => sum + p.mitigationOptions.length,
                        0
                      )}
                    </h4>
                  </div>
          ...
          {sortedPredictions.length > 0 ? (
                    ...
                    {groupedByTimeframe.short.length === 0 && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 mt-1 max-w-md mx-auto">
                          No significant short-term risks have been predicted
                          for your current trade portfolio.
                        </p>
                      </div>
                    )}
                  </TabsContent>
                  ...
                  <TabsContent value="medium" className="mt-4">
                    ...
                    {groupedByTimeframe.medium.length === 0 && (
                      <div className="text-center py-8">
                        <Clock className="mx-auto h-10 w-10 text-gray-300 mb-3" />
                        <h3 className="text-lg font-medium text-gray-900">
                          No Medium-Term Risks
                        </h3>
                        <p className="text-gray-500 mt-1 max-w-md mx-auto">
                          No significant medium-term risks have been predicted
                          for your current trade portfolio.
                        </p>
                      </div>
                    )}
                  ...
                  <TabsContent value="long" className="mt-4">
                    ...
                    {groupedByTimeframe.long.length === 0 && (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-500 mt-1 max-w-md mx-auto">
                          No significant long-term risks have been predicted for
                          your current trade portfolio.
                        </p>
                      </div>
                    )}
                  </TabsContent>
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {sortedPredictions.map((prediction, index) => {
                          const riskScore =
                            prediction.probability * prediction.impact;
                          ...
                          return (
                            <tr key={index} className="hover:bg-gray-50">
                              <td className="px-4 py-3 whitespace-nowrap">
                                <div className="flex items-center">
                                  <div
                                    className={`p-1.5 rounded-full bg-${color}-50 text-${color}-500 mr-2`}
                                  >
            ...
            <div className="text-center py-12 bg-white rounded-lg border shadow-sm">
              ...
              <p className="text-gray-500 mt-2 max-w-md mx-auto">
                No predictions match your current filter criteria. Try adjusting
                your filters or generate new insights.
              </p>
              <Button
                variant="outline"
                className="mt-4"
