...
const RiskInsightsList: React.FC<RiskInsightsListProps> = ({ insights }) => {
  ...
  const filteredInsights = insights.filter((insight) => {
    ...
    if (
      ...
      insight.riskLevel !== filters.riskLevel
    ) {
      return false;
    }
    ...
    if (
      ...
      insight.relatedCategory !== filters.category
    ) {
      return false;
    }
    ...
    if (
      filters.searchTerm &&
      !insight.title.toLowerCase().includes(filters.searchTerm.toLowerCase()) &&
      !insight.description
        .toLowerCase()
            ...
            {sortedInsights.length === 0 ? (
              <div className="py-12 text-center">
                ...
                <p className="text-gray-500 mt-1 max-w-md mx-auto">
                  No insights match your current filter criteria. Try adjusting
                  your filters or generating new insights.
                </p>
              ...
              sortedInsights.map((insight) => {
                ...
                return (
                  <Card
                    key={insight.id}
                    className={`border-l-4 border-l-${color}-500 shadow-sm`}
                  >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
                        <div className="space-y-2 flex-1">
                          <div className="flex items-start">
                            <div
                              className={`p-1.5 rounded-full bg-${color}-50 text-${color}-500 mr-2 mt-0.5`}
                            >
                          ...
                          <div className="flex flex-wrap items-center gap-2 text-xs text-gray-500 pl-9">
                            ...
                            <span className="text-xs">
                              Expires:{" "}
                              {new Date(insight.expiresAt).toLocaleDateString(
                                "en-US",
