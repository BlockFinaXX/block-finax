...
const CountryRiskMap: React.FC<CountryRiskMapProps> = ({ countryRisks }) => {
  ...
  const [sortBy, setSortBy] = useState<"country" | "overallRiskScore">(
    "overallRiskScore"
  );
  ...
  const [selectedCountry, setSelectedCountry] = useState<CountryRisk | null>(
    null
  );
  ...
  const filteredCountries = countryRisks.filter((country) => {
    ...
    const matchesRiskLevel =
      selectedRiskLevel === "all" || country.riskLevel === selectedRiskLevel;
  ...
  const countriesByRiskLevel = {
    ...
    [RiskLevel.MEDIUM]: countryRisks.filter(
      (c) => c.riskLevel === RiskLevel.MEDIUM
    ),
    [RiskLevel.HIGH]: countryRisks.filter(
      (c) => c.riskLevel === RiskLevel.HIGH
    ),
    [RiskLevel.CRITICAL]: countryRisks.filter(
      (c) => c.riskLevel === RiskLevel.CRITICAL
    ),
  };
            ...
            <div className="flex justify-center items-center p-4 bg-gray-50 rounded-lg border mb-4 h-[260px] relative">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500">
                  Interactive risk map would be rendered here
                </p>
                <p className="text-xs text-gray-400 mt-1">
                  Countries color-coded by risk level: {countryRisks.length}{" "}
                  countries analyzed
                </p>
              </div>
              ...
              <div className="absolute bottom-3 right-3 flex flex-col space-y-1 bg-white/80 p-2 rounded-md shadow-sm">
                <div className="flex items-center text-xs">
                  ...
                  <span>
                    Critical Risk (
                    {countriesByRiskLevel[RiskLevel.CRITICAL].length})
                  </span>
                </div>
                <div className="flex items-center text-xs">
                  <div className="w-3 h-3 rounded-full bg-orange-500 mr-1"></div>
                  <span>
                    High Risk ({countriesByRiskLevel[RiskLevel.HIGH].length})
                  </span>
                </div>
                <div className="flex items-center text-xs">
                  <div className="w-3 h-3 rounded-full bg-yellow-500 mr-1"></div>
                  <span>
                    Medium Risk ({countriesByRiskLevel[RiskLevel.MEDIUM].length}
                    )
                  </span>
                </div>
                <div className="flex items-center text-xs">
                  ...
                  <span>
                    Low Risk ({countriesByRiskLevel[RiskLevel.LOW].length})
                  </span>
                </div>
              </div>
            </div>
            ...
            <CardHeader className="pb-2">
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription>
                    ISO: {selectedCountry.iso} | Trading Partners:{" "}
                    {selectedCountry.tradingPartnerCount}
                  </CardDescription>
                </div>
                <Button
                  variant="ghost"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Progress
                    ...
                    className="h-2.5"
                    indicatorClassName={`bg-${getRiskLevelColor(
                      selectedCountry.riskLevel
                    )}-500`}
                  />
                ...
                <div className="space-y-3">
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <div className="text-sm font-medium">
                        {selectedCountry.politicalStabilityScore.toFixed(0)}%
                      </div>
                    </div>
                    <Progress
                      ...
                      className="h-1.5"
                      indicatorClassName={
                        selectedCountry.politicalStabilityScore > 60
                          ? "bg-green-500"
                          : "bg-orange-500"
                      }
                    />
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <div className="text-sm font-medium">
                        {selectedCountry.economicStabilityScore.toFixed(0)}%
                      </div>
                    </div>
                    <Progress
                      ...
                      className="h-1.5"
                      indicatorClassName={
                        selectedCountry.economicStabilityScore > 60
                          ? "bg-green-500"
                          : "bg-orange-500"
                      }
                    />
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <div className="text-sm font-medium">
                        {selectedCountry.regulatoryQualityScore.toFixed(0)}%
                      </div>
                    </div>
                    <Progress
                      ...
                      className="h-1.5"
                      indicatorClassName={
                        selectedCountry.regulatoryQualityScore > 60
                          ? "bg-green-500"
                          : "bg-orange-500"
                      }
                    />
                ...
                {selectedCountry.tradeRestrictions.length > 0 && (
                  <Card
                    className={`border-l-4 border-l-${getRiskLevelColor(
                      selectedCountry.riskLevel
                    )}-500 bg-gray-50`}
                  >
                    <CardContent className="p-3 space-y-1">
                      ...
                      <ul className="text-sm space-y-1">
                        {selectedCountry.tradeRestrictions.map(
                          (restriction, index) => (
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>
                        Consider requiring Letter of Credit for all transactions
                        in this region.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        Implement additional due diligence for partners in this
                        country.
                      </span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span>
                        Monitor currency fluctuations closely for impact on
                        contracts.
                      </span>
                    </li>
                  </ul>
          ...
          <Card className="shadow-md overflow-hidden">
            ...
            <CardContent className="pt-4">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>
                        {countriesByRiskLevel[RiskLevel.HIGH].length} countries
                      </span>
                    </div>
                    <Progress
                      value={
                        (countriesByRiskLevel[RiskLevel.HIGH].length /
                          countryRisks.length) *
                        100
                      }
                      className="h-2"
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>
                        {countriesByRiskLevel[RiskLevel.MEDIUM].length}{" "}
                        countries
                      </span>
                    </div>
                    <Progress
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-1">
                      ...
                      <span>
                        {countriesByRiskLevel[RiskLevel.LOW].length} countries
                      </span>
                    </div>
                    <Progress
                      value={
                        (countriesByRiskLevel[RiskLevel.LOW].length /
                          countryRisks.length) *
                        100
                      }
                      className="h-2"
              ...
              <div className="mt-4 text-center">
                <p className="text-sm text-gray-500">
                  Click on a country from the list below to view detailed risk
                  assessment
                </p>
              </div>
            </CardContent>
        ...
        {showFilters && (
          <CardContent className="border-b pb-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <div className="space-y-1">
                ...
                <div className="flex space-x-1">
                  <Button
                    variant={
                      selectedRiskLevel === "all" ? "default" : "outline"
                    }
                    size="sm"
                  ...
                  <Button
                    variant={
                      selectedRiskLevel === RiskLevel.CRITICAL
                        ? "default"
                        : "outline"
                    }
                    size="sm"
            ...
            <div className="flex justify-between mt-3">
              <div className="text-xs text-gray-500">
                Showing {filteredCountries.length} of {countryRisks.length}{" "}
                countries
              </div>
          ...
          {sortedCountries.length === 0 ? (
            <div className="text-center py-12 bg-white rounded-lg border shadow-sm">
              ...
              <p className="text-gray-500 mt-2 max-w-md mx-auto">
                No countries match your current filter criteria. Try adjusting
                your filters or expanding your search.
              </p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 text-sm">
                          {country.politicalStabilityScore.toFixed(0)}%
                        </td>
                        <td className="px-4 py-3 text-sm">
                          {country.economicStabilityScore.toFixed(0)}%
                        </td>
                        <td className="px-4 py-3 text-sm">
                          {country.regulatoryQualityScore.toFixed(0)}%
                        </td>
                        <td className="px-4 py-3 text-sm">
                          {country.tradingPartnerCount}
                        </td>
                        <td className="px-4 py-3">
                          {country.tradeRestrictions.length > 0 ? (
                            <Badge
                            ...
                            >
                              {country.tradeRestrictions.length} restriction
                              {country.tradeRestrictions.length !== 1
                                ? "s"
                                : ""}
                            </Badge>
                          ) : (
