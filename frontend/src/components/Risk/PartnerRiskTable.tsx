...
const PartnerRiskTable: React.FC<PartnerRiskTableProps> = ({
  partnerRisks,
}) => {
  ...
  const [selectedPartner, setSelectedPartner] = useState<PartnerRisk | null>(
    null
  );
  ...
  const filteredPartners = partnerRisks.filter((partner) => {
    ...
    const matchesRiskLevel =
      riskLevelFilter === "all" || partner.riskLevel === riskLevelFilter;
  ...
  const partnersByRiskLevel = {
    ...
    [RiskLevel.MEDIUM]: partnerRisks.filter(
      (p) => p.riskLevel === RiskLevel.MEDIUM
    ),
    [RiskLevel.HIGH]: partnerRisks.filter(
      (p) => p.riskLevel === RiskLevel.HIGH
    ),
    [RiskLevel.CRITICAL]: partnerRisks.filter(
      (p) => p.riskLevel === RiskLevel.CRITICAL
    ),
  };

  // Calculate trade volume statistics
  const totalTradeVolume = partnerRisks.reduce(
    (sum, p) => sum + p.totalTradeVolume,
    0
  );
  const avgTransactionSize =
    partnerRisks.reduce((sum, p) => sum + p.avgTransactionSize, 0) /
    (partnerRisks.length || 1);
              ...
              <CardContent className="p-4">
                ...
                <div className="mt-3 pt-3 border-t flex items-center text-xs text-gray-500">
                  ...
                  <div className="flex items-center mr-3">
                    ...
                    <span>
                      Medium: {partnersByRiskLevel[RiskLevel.MEDIUM].length}
                    </span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 rounded-full bg-green-500 mr-1"></div>
                    <span>
                      Low: {partnersByRiskLevel[RiskLevel.LOW].length}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="p-4">
                ...
                <div className="mt-3 pt-3 border-t flex items-center justify-between text-xs">
                  <div className="text-gray-500">
                    Avg. Transaction: ${avgTransactionSize.toLocaleString()}
                  </div>
                    ...
                    .map((partner) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center">
                            <div
                              className={`p-2 rounded-full bg-${color}-50 text-${color}-500 mr-3`}
                            >
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                {partner.country} • {partner.relationshipYears}{" "}
                                year{partner.relationshipYears !== 1 ? "s" : ""}{" "}
                                relationship
                              </p>
                            </div>
                          </div>
                  ...
                  {partnerRisks.filter(
                    ...
                    <div className="text-center py-6">
                      ...
                      <h3 className="text-lg font-medium text-gray-900">
                        No High Risk Partners
                      </h3>
                      <p className="text-gray-500 mt-1 max-w-md mx-auto">
                        None of your trading partners currently have a high risk
                        rating.
                      </p>
                    </div>
                  )}
              ...
              <CardContent>
                  ...
                  <Card className="bg-white shadow-sm">
                    <CardContent className="p-3 text-center">
                      ...
                      <div className="text-lg font-semibold text-green-600 mt-1">
                        {partnerRisks.reduce(
                          (sum, p) => sum + p.paymentHistory.onTimePayments,
                          0
                        )}
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-white shadow-sm">
                    <CardContent className="p-3 text-center">
                      ...
                      <div className="text-lg font-semibold text-yellow-600 mt-1">
                        {partnerRisks.reduce(
                          (sum, p) => sum + p.paymentHistory.latePayments,
                          0
                        )}
                      </div>
                    </CardContent>
                  ...
                  <Card className="bg-white shadow-sm">
                    <CardContent className="p-3 text-center">
                      ...
                      <div className="text-lg font-semibold text-red-600 mt-1">
                        {partnerRisks.reduce(
                          (sum, p) => sum + p.paymentHistory.missedPayments,
                          0
                        )}
                      </div>
                    </CardContent>
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-medium">
                    Partners with Payment Issues
                  </h4>
                  {partnerRisks
                    .filter(
                      (p) =>
                        p.paymentHistory.latePayments > 0 ||
                        p.paymentHistory.missedPayments > 0
                    )
                    .sort(
                      (a, b) =>
                        b.paymentHistory.missedPayments * 3 +
                        b.paymentHistory.latePayments -
                        (a.paymentHistory.missedPayments * 3 +
                          a.paymentHistory.latePayments)
                    )
                    .slice(0, 3)
                    .map((partner) => (
                      <div
            ...
            {showFilters && (
              <CardContent className="border-b pb-4">
                ...
                <div className="flex justify-between mt-3">
                  <div className="text-xs text-gray-500">
                    Showing {filteredPartners.length} of {partnerRisks.length}{" "}
                    partners
                  </div>
              ...
              {sortedPartners.length === 0 ? (
                <div className="text-center py-12 bg-white rounded-lg border shadow-sm">
                  ...
                  <p className="text-gray-500 mt-2 max-w-md mx-auto">
                    No partners match your current filter criteria. Try
                    adjusting your filters or expanding your search.
                  </p>
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {sortedPartners.map((partner) => {
                        const color = getRiskLevelColor(partner.riskLevel);
                        const creditColor = getCreditScoreColor(
                          partner.creditScore
                        );
                          ...
                          >
                            ...
                            <td className="px-4 py-3">
                              <div className="flex space-x-1 text-xs">
                                ...
                                >
                                  {partner.paymentHistory.onTimePayments}{" "}
                                  On-time
                                </Badge>
                                {partner.paymentHistory.latePayments > 0 && (
                                  <Badge
                                ...
                                {partner.paymentHistory.missedPayments > 0 && (
                                  <Badge
                                    ...
                                    className="bg-red-50 text-red-700 border-red-200"
                                  >
                                    {partner.paymentHistory.missedPayments}{" "}
                                    Missed
                                  </Badge>
                                )}
                              </div>
                            ...
                            <td className="px-4 py-3 text-sm">
                              {partner.relationshipYears} year
                              {partner.relationshipYears !== 1 ? "s" : ""}
                            </td>
                            <td className="px-4 py-3">
                              {partner.recentFlags.length > 0 ? (
                                ...
                                >
                                  {partner.recentFlags.length} flag
                                  {partner.recentFlags.length !== 1 ? "s" : ""}
                                </Badge>
                              ) : (
                ...
                <div className="flex justify-between">
                  <div>
                    ...
                    <CardDescription>
                      ...
                      {selectedPartner.relationshipYears} year
                      {selectedPartner.relationshipYears !== 1 ? "s" : ""}{" "}
                      relationship
                    </CardDescription>
                  </div>
                  <Button
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        ...
                        <Badge
                          className={`bg-${getRiskLevelColor(
                            selectedPartner.riskLevel
                          )}-100 text-${getRiskLevelColor(
                            selectedPartner.riskLevel
                          )}-700 border-${getRiskLevelColor(
                            selectedPartner.riskLevel
                          )}-200`}
                        >
                          {selectedPartner.riskLevel}
                      ...
                      <Progress
                        ...
                        className="h-2.5"
                        indicatorClassName={`bg-${getCreditScoreColor(
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-medium">
                            ${selectedPartner.totalTradeVolume.toLocaleString()}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          <div className="flex items-center">
                          ...
                          <span className="font-medium">
                            $
                            {selectedPartner.avgTransactionSize.toLocaleString()}
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          <div className="flex items-center">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-medium">
                            {new Date().getFullYear() -
                              selectedPartner.relationshipYears}
                          </span>
                        </div>
                      </div>
                    </div>
                        ...
                        <ul className="space-y-2 text-sm">
                          {selectedPartner.riskLevel !== RiskLevel.LOW && (
                            <>
                              <li className="flex items-start">
                                ...
                                <span>
                                  Implement credit limits appropriate for the{" "}
                                  {selectedPartner.creditScore}% credit score.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <Check className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                                <span>
                                  Require secured payment methods for all
                                  transactions.
                                </span>
                              </li>
                              <li className="flex items-start">
                                <Check className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                                <span>
                                  Schedule quarterly credit reviews due to the{" "}
                                  {selectedPartner.riskLevel.toLowerCase()} risk
                                  level.
                                </span>
                              </li>
                            </>
                          ...
                          {selectedPartner.paymentHistory.missedPayments >
                            ...
                            <li className="flex items-start">
                              <Check className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                              <span>
                                Require advance payment or Letter of Credit for
                          ...
                          {selectedPartner.riskLevel === RiskLevel.LOW &&
                            selectedPartner.paymentHistory.missedPayments ===
                              ...
                              <li className="flex items-start">
                                <Check className="h-4 w-4 text-green-500 mr-2 mt-0.5" />
                                <span>
                                  Partner represents low risk - consider
                                  offering preferential trade terms.
                                </span>
                              </li>
                            )}
                        </ul>
              ...
              <div className="flex justify-center items-center p-6 bg-gray-50 rounded-lg border mb-4 h-64 relative">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-500">
                    Risk factor distribution chart would render here
                  </p>
                  <p className="text-xs text-gray-400 mt-1">
                    Showing distribution of {partnerRisks.length} partners by
                    risk category
                  </p>
                </div>
              </div>
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          ...
                          {partnerRisks.length
                            ? (
                                (partnersByRiskLevel[RiskLevel.CRITICAL]
                                  .length /
                                  partnerRisks.length) *
                                100
                              ).toFixed(0)
                  ...
                  <div className="space-y-2">
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            partnerRisks.filter((p) => p.creditScore >= 80)
                              .length
                          }
                          (
                          {partnerRisks.length
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            partnerRisks.filter(
                              (p) => p.creditScore >= 60 && p.creditScore < 80
                            ).length
                          }
                          (
                          {partnerRisks.length
                            ? (
                                (partnerRisks.filter(
                                  (p) =>
                                    p.creditScore >= 60 && p.creditScore < 80
                                ).length /
                                  partnerRisks.length) *
                                100
                              ).toFixed(0)
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            partnerRisks.filter(
                              (p) => p.creditScore >= 40 && p.creditScore < 60
                            ).length
                          }
                          (
                          {partnerRisks.length
                            ? (
                                (partnerRisks.filter(
                                  (p) =>
                                    p.creditScore >= 40 && p.creditScore < 60
                                ).length /
                                  partnerRisks.length) *
                                100
                              ).toFixed(0)
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            partnerRisks.filter(
                              (p) => p.creditScore >= 20 && p.creditScore < 40
                            ).length
                          }
                          (
                          {partnerRisks.length
                            ? (
                                (partnerRisks.filter(
                                  (p) =>
                                    p.creditScore >= 20 && p.creditScore < 40
                                ).length /
                                  partnerRisks.length) *
                                100
                              ).toFixed(0)
                    ...
                    <div>
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>
                          {
                            partnerRisks.filter((p) => p.creditScore < 20)
                              .length
                          }
                          (
                          {partnerRisks.length
